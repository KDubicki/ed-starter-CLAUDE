    ...
    <div className="min-h-screen bg-board-bg">
      ...
      <div className="bg-board-header border-b border-board-border px-6 py-3 flex flex-wrap gap-4 items-center">
        ...
        <input
          ...
          className="bg-board-row border border-board-border text-board-text text-xs px-3 py-1.5 rounded focus:outline-none focus:border-amber-600 w-36 placeholder:text-board-muted"
        />
